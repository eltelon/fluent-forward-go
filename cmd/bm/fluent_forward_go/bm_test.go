...
//go test -benchmem -benchtime=100x -run=^$ -bench ^Benchmark.*$ github.com/eltelon/fluent-forward-go/cmd/bm/fluent_forward_go

import (
	"testing"
	"time"

	"github.com/eltelon/fluent-forward-go/cmd/bm"
